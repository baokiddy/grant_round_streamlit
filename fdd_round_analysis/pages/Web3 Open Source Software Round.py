...
apps = pd.DataFrame.from_dict(get_fresh_query_result(st.secrets['redash_url'], st.secrets['app_query_id'], st.secrets['redash_key']))
votes = pd.DataFrame.from_dict(get_fresh_query_result(st.secrets['redash_url'], st.secrets['votes_query_id'], st.secrets['redash_key']))
