...
apps = pd.DataFrame.from_dict(get_fresh_query_result(st.secrets['redash_url'], st.secrets['eth_app_query_id'], st.secrets['redash_key']))
votes = pd.DataFrame.from_dict(get_fresh_query_result(st.secrets['redash_url'], st.secrets['eth_votes_query_id'], st.secrets['redash_key']))
